...
Correlation (r)", 
 main = "Average Correlation Plot of Tumor v. Normal samples", axes = F) 
...
plot(c(1, ncol(dat)), range(all.probesets), type = 'n', main="Profile plot of KNG1 and 
AQP2", 
 xlab = "Samples", ylab = "Expression Intensity", axes = F) 
...
plot(c(1, ncol(dat)), range(KNG.probesets), type = 'n', main="Profile plot of KNG1", 
 xlab = "Samples", ylab = "Expression Intensity", axes = F) 
axis(side=1, at=c(1:20), labels = dimnames(probesets)[[2]], cex.axis = 0.4, las = 2) 
axis(side=2) 
...
plot(c(1, ncol(dat)), range(AQP), type = 'n', main="Profile plot of AQP2", 
 xlab = "Samples", ylab = "Expression Intensity", axes = F) 
axis(side=1, at=c(1:20), labels = dimnames(probesets)[[2]], cex.axis = 0.4, las = 2) 
axis(side=2) 
...
plot(c(1, ncol(dat)), range(dat.pca.knn), type = "n", 
 main = "Profile plot of probeset 206054_at\nwith actual and imputed values of 
GSM146784_Normal", 
 xlab = "Samples", ylab = "Expression Intensity", axes = F) 
axis(side = 1, at = 1:length(dat), labels = dimnames(dat.pca.knn)[[2]], cex.axis = 0.4, las 
= 2) 
axis(side = 2) 
